...
ADMINS_DEFAULT = []
if (
    os.getenv("TELEGRAM_ADMIN_DEFAULT")
    and os.getenv("TELEGRAM_ADMIN_DEFAULT").isdigit()
):
...
DICT_MESSAGES = {
    ...
    "admin_settings": "Так як ви тренер без студентів, вам це функціонал непотрібен",
    "settings_basic": "Ваш профіль",
    "coach_settings": "<b>Список студентів:</b>",
...
schedule_admin_change = (
    lambda x: f"Адміністратор {x} замінив розклад. Візьміть це на розгляд"
)
