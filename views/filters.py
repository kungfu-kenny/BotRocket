...
class CheckContinueChannels(Filter):
    ...
    async def check(self, call: CallbackQuery) -> bool:
        ...
        return (
            len(call_use) == 2 and
            call_use[0] == CALLBACKS["channel_change"]
        )
...
class CheckNextEvent(Filter):
    ...
    async def check(self, call: CallbackQuery) -> bool:
        ...
        return (
            len(call_use) == 2 and
            call_use[0] == CALLBACKS["event_next"]
        )
...
class CheckGetUserAdmin(Filter):
    ...
    async def check(self, call: CallbackQuery) -> bool:
        ...
        return (
            len(call_use) == 3 and
            call_use[0] == CALLBACKS['admin_select']
        )
...
class CheckAdminConfirm(Filter):
    ...
    async def check(self, call: CallbackQuery) -> bool:
        ...
        return (
            len(call_use) == 2 and
            call_use[0] == CALLBACKS["receive_invoice"]
        )
...
class CheckAdminConfirmFile(Filter):
    ...
    async def check(self, call: CallbackQuery) -> bool:
        ...
        return (
            len(call_use) == 2 and
            call_use[0] == CALLBACKS["receive_invoice_file"]
        )
...
class CheckAdminSelectNext(Filter):
    ...
    async def check(self, call: CallbackQuery) -> bool:
        ...
        return (
            len(call_use) == 2 and
            call_use[0] == CALLBACKS["admin_next"]
        )
